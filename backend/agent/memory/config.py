...
# 摘要生成目标独立于验收上限；有效目标限制在 1 到验收上限之间。
CHAT_COMPACT_SUMMARY_TARGET_TOKENS = int(os.getenv("CHAT_COMPACT_SUMMARY_TARGET_TOKENS", "600"))
# 摘要正文验收上限；完整请求仍受独立上下文预算约束。
CHAT_COMPACT_SUMMARY_MAX_TOKENS = int(os.getenv("CHAT_COMPACT_SUMMARY_MAX_TOKENS", "900"))
