...
from core.sources import (
    ...
    build_web_snippet_source,
    build_web_source_entry,
    ...
    parse_source_ids,
    safe_canonicalize_url,
    sanitize_cited_source_text,
    select_page_sources,
    select_web_sources,
)
...
def collect_web_sources(query: str, source_start_index: int) -> tuple[list[dict[str, Any]], dict[str, Any]]:
    ...
    sources = select_web_sources(
        ranked_candidates,
        source_start_index,
        max_sources=WEB_MAX_SOURCES,
        max_sources_per_domain=WEB_MAX_SOURCES_PER_DOMAIN,
        max_chunks_per_url=WEB_MAX_CHUNKS_PER_URL,
    )
